...
def rsd2ltf(rsd_str, doc_id,
    ...
    for i in range(len(sents)):
        ...
        seg_element = ET.Element('SEG', {'id': seg_id,
                                         'start_char': str(seg_start_char + 1),
                                         'end_char': str(seg_end_char + 1)})
        ...
        for j in range(len(tokens[i])):
            ...
            token_element = ET.Element('TOKEN',
                                       {'id': token_id,
                                        'start_char': str(tok_start_char + 1),
                                        'end_char': str(tok_end_char + 1)})
...
if __name__ == "__main__":
    ...
    parser.add_argument('--tok_option', default='nltk_wordpunct',
